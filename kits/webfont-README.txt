昌明體 ChangMing Serif TC {{VERSION}}：網頁字型包（分片版）
...
2. 在每個頁面的 <head> 加入（路徑依實際位置調整）：
   ...
   <link rel="preload" href="/assets/changming/fonts/{{PRELOAD_L0}}" as="font" type="font/woff2" crossorigin>
   <link rel="preload" href="/assets/changming/fonts/{{PRELOAD_H0}}" as="font" type="font/woff2" crossorigin>
